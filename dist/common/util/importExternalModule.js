...
exports.importExternalModule = importExternalModule;
const importExternalPlugin_1 = require("./importExternalPlugin");
/**
...
function importExternalModule(location) {
    return __awaiter(this, void 0, void 0, function* () {
        const plugin = yield (0, importExternalPlugin_1.importExternalPlugin)(location);
